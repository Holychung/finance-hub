...
views.settings = async () => {
  ...
  mount(main, html`
    ...
    <section class="card">
      ...
      <div class="note warn">
        這是這個 app 兩個<b>會對外連線</b>的功能之一（另一個是 <a href="/ai">AI 健檢</a>），<b>預設關閉</b>。打開後，每天第一次啟動服務時會到
    ...
    <section class="card">
      ...
      <div class="muted small">
        ...
        只監聽 127.0.0.1；預設不對外連線。會連出去的只有兩個你自己打開的功能，都在後端連：上面的「自動更新收盤價」，
        以及 <a href="/ai">AI 健檢</a>（只在你按下送出時）。
